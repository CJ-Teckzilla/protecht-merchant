    ...
    $('#merchant_form').bind('submit', function(e){
         ...
         //Ajax call to retrieve token from server
          $.get(baseURL+ "get_token.php", function(data) {
            console.log(data);
            var url = baseURL+"hostedpage.html?"+json_data+"&token="+data+"&callbackurl="+callbackurl+"&key=pk_sandbox_c24dc55e4d07719b80c0916ce8a28e4dbf6a048f"+"&number=4242424242424242"+"&cvv=589"+"&expiration_date=12/24";
            console.log(url);
